...
@NgModule({
  imports: [RouterModule.forRoot([{ path: 'form-1-control-name', component: AuthNameComponent }, { path: 'form-1-control-age', component: AuthAgeComponent }, { path: 'form-1-control-email', component: AuthEmailComponent }, { path: 'form-1-control-comment', component: AuthCommentComponent }, { path: 'auth-single-page', component: AuthSinglePageComponent }, { path: 'success', component: SuccessComponent }, { path: 'error', component: ErrorComponent }]), AuthNameComponentModule, AuthAgeComponentModule, AuthEmailComponentModule, AuthCommentComponentModule, AuthSinglePageComponentModule, SuccessComponentModule, ErrorComponentModule],
